...
//			"http://av.vimeo.com/12067/403/106802665.mp4?download=1&token2=1406580578_b736cf91787070149db5c21909d920e3&filename=Reel%25202012-HD.mp4";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// this activity.
		mSystemUiHider = SystemUiHider.getInstance(this, mVideoHolder,
				HIDER_FLAGS);
				...
				.setOnVisibilityChangeListener(new SystemUiHider.OnVisibilityChangeListener() {
					...
					public void onVisibilityChange(boolean visible) {
						if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
							...
							// controls.
							mControlsView.setVisibility(visible ? View.VISIBLE
									: View.GONE);
						}
		...
		mVideoHolder.setVideoURI(Uri.parse(MOVIE_URL));
